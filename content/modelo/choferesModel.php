	...
	class choferesModel extends database{
		...
		public function Agregar(){
			...
			try {
				...
				// echo $id;
				$query = parent::prepare("INSERT INTO choferes (id_choferes, cedula,  nombre, apellido, telefono, placa, status) VALUES ($id, '{$this->cedula}', '{$this->nombre}', '{$this->apellido}', '{$this->telefono}','{$this->placa}', 1)");
				$respuestaArreglo = '';
				$query->execute();
				$query->setFetchMode(parent::FETCH_ASSOC);
				$respuestaArreglo = $query->fetchAll(parent::FETCH_ASSOC); 
		...
		public function Modificar(){
			try{
				$query = parent::prepare("UPDATE choferes SET cedula='{$this->cedula}', nombre='{$this->nombre}', apellido = '{$this->apellido}', telefono = '{$this->telefono}', placa = '{$this->placa}' WHERE id_choferes = {$this->id_choferes}");
				$respuestaArreglo = '';
				$query->execute();
				$query->setFetchMode(parent::FETCH_ASSOC);
				$respuestaArreglo = $query->fetchAll(parent::FETCH_ASSOC); 
