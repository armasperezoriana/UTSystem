	...
	class mantenimientoModel extends database{
		...
		public function Consultar(){
			...
			try {
				...
				$query = parent::prepare('SELECT mantenimientos.id_taller AS taller, taller.nombre AS nombre_taller, taller.rif AS rif, mantenimientos.nombre AS nombre_mantenimiento, vehiculos.placa AS placa, mantenimientos.id_mantenimiento AS orden, mantenimientos.estado AS estado, mantenimientos.status AS status FROM mantenimientos INNER JOIN vehiculos ON mantenimientos.id_vehiculo = vehiculos.id_vehiculo INNER JOIN taller 
