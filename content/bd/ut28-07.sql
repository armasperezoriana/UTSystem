...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-07-2022 a las 01:23:58
...
(1, 'EAP685', 'Oriana', 'Armas', '26561634', '04160360067', 1),
(2, 'GAP173', 'ERWIN ELIAS', 'ARMAS GONZALEZ', '95589666', '04160360067', 1),
(3, '898PAJ4', 'Elias', '5654545', '308386512', '0412788593', 1),
...
(3, 300, '7', 9, 'Cambio de Aceite', '15.0', '2022-02-15', 1, 2),
...
(8, 30, '', 33, 'Cauchos', 'vvvcvb', '2022-07-16', 1, 3),
(9, 15000, '', 34, 'Luces', '45,4', '2022-07-23', 1, 7);
...
(1, 0, '2022-07-28', 'Mantenimiento preventivo QQQ778', 'El vehículo QQQ778 necesita mantenimiento de: filtro de aceite, y chequeo general.', 37),
...
(6, 0, '2022-07-28', 'Mantenimiento preventivo 555TRB', 'El vehículo 5555555555 necesita mantenimiento de: filtro de aceite, frenos, refrigeración, electroventilador, y chequeo general.', 42),
...
(8, 0, '2022-07-28', 'Mantenimiento preventivo requerido para PPA990', 'El vehículo PPA990 necesita mantenimiento de: filtro de aceite, y chequeo general.', 45);
...
(1, 4, 'Elias', '20000', '2022-07-07', 'nn', 1, 4),
(2, 1, 'Bombilla', '8', '2022-06-30', 'exploto una luz tracera', 1, 9),
(3, 9, 'Michellin', 'vvvcvb', '2022-07-15', 'cambio de cauchos', 1, 13),
...
(5, 'hjhk', 'jkjkjklhgjh', 0),
(6, 'WAKAWAKA', 'WAKAWAKA', 1);
...
(7, '898PAJ4', 'Barrio Union', 'calle cuatro con seis hasta la macias', '13:15:00', '8,3', 1, 0, NULL, NULL),
...
(5, '98657412', 'ogapcvc55', 'Miguel', 'Martinez Ochoa', '$%%$$%%$$%%$%$$/%%$$$%$$%%$$%$$', 1, 1, 'administrador@gmail.com', '2022-07-27 23:04:02'),
(10, '9867412', 'Gilspa14', 'Gilmary', 'Sanz', '$%%$$%%$$%%$%$$/%%$$$%$$%%$$%$$', 2, 1, 'fddf@gmail.com', '0000-00-00 00:00:00');
...
(1, 'OGA1703', 'Encava', 'Operativo', NULL, '9,5', NULL, 1),
...
--
ALTER TABLE `bitacora`
  MODIFY `id_bitacora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=672;
