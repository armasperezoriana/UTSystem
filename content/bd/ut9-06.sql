...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-06-2022 a las 06:24:13
...
(1, 300, '1', 6, 'Restauracion', '500', '2022-06-01', 1, 1);
...
(7, '898PAJ4', 'Barrio Union', 'calle 4 con 6 hasta la macias', '13:15:00', '8,3', 1),
(10, 'GAP173', 'Corrido Rapido', 'Centro', '23:29:00', '0', 0),
(12, 'YYLA891', 'UPTAEB', 'av la salle con corpahuaico', '12:15:00', '0', 1),
(1, 'KOWP145', 'ZonaNorte', 'Zona norte, Yucatan', '12:30:00', '1,5', 1),
(13, 'KVT47V', 'el espanto', 'calle 13 con carrera 43', '01:15:00', '0', 1),
...
--
ALTER TABLE `bitacora`
  MODIFY `id_bitacora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=545;
...
--
ALTER TABLE `mantenimientos`
  MODIFY `id_mantenimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `mantenimientos`
  ADD CONSTRAINT `fk_id_taller` FOREIGN KEY (`id_taller`) REFERENCES `taller` (`id_taller`),
