...
<div class="modal-dialog"   role="document" style="position: relative;top: 100%; width:400%; height:800%; right:8%;"> 
    <div class="modal-content">
      <div class="modal-header">
        <center><h5>Restauración de BD</h5></center>
      ...
      <div style="width:100%">
                            ...
                            <div class="contenedor" id="pasouno">
                                    <div class="text-center">
                                          <p class="mb-4">Operación Exitosa</p>
                                    </div>
                                   <h2> <a class="small" href="<?= _ROUTE_ ?>Respaldar">Hemos restaurado tu base de datos a un estado anterior!</a></h2>
                                    <hr>
                                    <br>  <br> 
                            </div>
                        </div>
