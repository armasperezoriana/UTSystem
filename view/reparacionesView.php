...
<body id="page-top">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="table-responsive">
                                <div class="card-body" style='background:;'>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row no-gutters align-items-center">
                                                                    <button class=" btn btn-danger" type="submit"
                                                                        onclick="reportarPDF();"><a
                                                                        href="<?=_REPORTS_?>Reparaciones/ordenindividual.php?id=<?=$rep['id_reparaciones'] ?>"
                                                                            target="blank">
                                                                            <font color="white">PDF</font>
                                                                        </a><i
                                                                            class="fas fa-print fa-1x text-gray-250"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                </td>
                                                <td>
                                                            <div class="col-sm-7" style='text-align:right;'>
                                                                <a href="#" data-id="<?= $value['id_vehiculo'] ?>"
                                                                    ...
                                                                    name="consultar"
                                                                    data-target="#ConsultarMantenimientoModal<?=$rep['id_reparaciones'] ?>"
                                                                    data-toggle="modal">
                                                                    <span class="icon text-white-50">
                                                    ...
                                                    <td>
                                                        <div class="col-sm-7" style='text-align:right;'>
                                                            <a href="#" class="btn btn-warning btn-icon-split editarbtn"
                                                                ...
                                                                data-toggle="modal"
                                                                data-target="#ModificarReparacionesModal<?=$rep['id_reparaciones']?>">
                                                                <span class="icon text-white-50">
                                                            ...
                                                            <div class="modal fade"
                                                                id="ConsultarMantenimientoModal<?=$rep['id_reparaciones'] ?>"
                                                                ...
                                                                <div class="container">
                                                                    <div class="modal-dialog">
                                                                        <form id="modificarReparacion" method="POST">
                                                                            <input type="hidden" id="id_reparaciones"
                                                                                name="id_reparaciones">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header bg-primary"
                                                                                    style="color:#FFF">
                                                                                    <h5 class="modal-title">Consultar
                                                                                        Reparación</h5>
                                                                                </div>
                                                                                <div class="modal-body">
                                                                                    <div class="row">
                                                                                        <div
                                                                                            ...
                                                                                            <select
                                                                                                ...
                                                                                                <option
                                                                                                    value="<?php echo $rep['id_vehiculo'] ;?>"
                                                                                                    <?php if($unidad['id_vehiculo']==$rep['id_vehiculo']){echo "selected";} ?>>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div
                                                                                            ...
                                                                                            <select
                                                                                                class="form-control select2 text-left"
                                                                                                style="width:80%;"
                                                                                                name="id_taller"
                                                                                                id="id_taller" disabled>
                                                                                                <option></option>
                                                                                                <?php foreach ($taller as $ta) : ?>
                                                                                                <?php if (!empty($ta['id_taller'])) : ?>
                                                                                                <option
                                                                                                    value="<?=$ta['id_taller']?>"
                                                                                                    <?php if($ta['id_taller']==$rep['id_taller']){ echo "selected"; } ?>>
                                                                                                    <?=$ta['nombre']?> -
                                                                                                    <?=$ta['rif']?>
                                                                                                </option>
                                                                                                <?php endif ?>
                                                                                        ...
                                                                                        <div
                                                                                            class="form-group col-sm-12 col-md-6">
                                                                                            <label
                                                                                                for="descripcion"><b>Descripción</b></label>
                                                                                            <input type="text"
                                                                                                class="form-control-plaintext"
                                                                                                disabled
                                                                                                style="width:100%;"
                                                                                                ...
                                                                                                <div class="col mr-2">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <input
                                                                                                            ...
                                                                                                            id="id_reparaciones"
                                                                                                            name="id_reparaciones">
                                                                                                        <a href="<?=_REPORTS_?>Reparaciones/ordenindividual.php?id=<?=$rep['id_reparaciones'] ?>"
                                                                                                            target="blank">
                                                                                                            <h6>iMPRIMIR
                                                                                                                ORDEN DE
                                                                                                                REPARACION
                                    ...
                                    <div class="modal fade" id="ModificarReparacionesModal<?=$rep['id_reparaciones']?>"
                                        tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                        aria-hidden="true" style="padding:0;text-align:left;">
                                        <div class="container">
                                            <div class="modal-dialog">
                                                <form id="modificarReparacion" method="POST">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="form-group col-sm-12 col-md-8">
                                                                    ...
                                                                    <select class="form-control select2"
                                                                        style="width:60%;" name="id_vehiculo"
                                                                        id="id_vehiculo">
                                                                        <option></option>
                                                                        <?php foreach ($vehiculo as $unidad) : ?>
                                                                        <?php if (!empty($unidad['id_vehiculo'])) : ?>
                                                                ...
                                                                <div class="form-group col-sm-12 col-md-4">
                                                                    <label for="intervalo"><b>Fecha de la
                                                                            reparación</b></label>
                                                                    <input type="date" class="form-control"
                                                                        style="width:100%;" value="<?=$rep['fecha']?>"
                                                                        name="intervalo" id="intervalo">
                                                                    <span class="errorIntervalo"
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-sm-12 col-md-6">
                                                                    <label for="nombre"><b>Nombre del
                                                                            mantenimiento</b></label>
                                                                    <input type="text" class="form-control"
                                                                        style="width:100%;" value="<?=$rep['nombre']?>"
                                                                ...
                                                                <div class="form-group col-sm-12 col-md-6">
                                                                    ...
                                                                    <input type="text" step="0.1" class="form-control"
                                                                        style="width:100%;" value="<?=$rep['costo']?>"
                                                                        name="costo" id="costo">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-sm-12 col-md-6">
                                                                    ...
                                                                    <select class="form-control select2 text-left"
                                                                        style="width:100%;" name="id_taller"
                                                                        id="id_taller">
                                                                        <option></option>
                                                                        <?php foreach ($taller as $ta) : ?>
                                                                        <?php if (!empty($ta['id_taller'])) : ?>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button class=" btn btn-secondary" type="button"
                                                                data-dismiss="modal">Cancelar</button>
                                                            <a class="EnviarReparacionesModificar btn btn-primary"
                                                                href="#" id="<?=$rep['id_reparaciones']?>">Guardar
                                                                Cambios</a>
                                                        </div>
                                                    </div>
                                            </div>
                            ...
                            <td>
                                <div class="col-sm-7" style='text-align:right;'>
                                    <?php if ($rep['status'] == 1) { ?>
                                    <a href="#" data-id="<?= $rep['id_reparaciones'] ?>"
    ...
    <div class="modal fade" id="AgregarReparacionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="container">
            <div class="modal-dialog">
                <div class="" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-primary" style="color:#FFF">
                            <h5 class="modal-title" id="exampleModalLabel">Registrar Mantenimiento Correctivo-Reparación
                            </h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="date" class="form-control" style="width:100%;" name="intervalo"
                                        id="intervalo">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-6">
                                    <label for="Nombre"><b>Reparación de :</b></label> <select
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-6">
                                    <label for="taller"><b>Taller</b></label>
                                    <select class="form-control select2" style="width:100%;" name="id_taller"
                                        id="id_taller">
                                        <option></option>
                                        <?php foreach ($taller as $ta) : ?>
                                        <?php if (!empty($ta['id_taller'])) : ?>
                ...
                <div class="" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>
                                    En este modulo podrá visualizar las reparaciones que están registradas en el sistema
                                    a su vez registrar, eliminar y modificar
                                    <br><br>
                                    1. Para eliminar una reparacion seleccione "eliminar" situada a la derecha de la
                                    reparacion
                                    <br> <br>
                                    2. Para modificar una reparacion seleccione "modificar" situada a izquierda de la
                                    reparacion
                                    <br><br>
                                    3. Para registrar una reparacion seleccione "registrar" que se muestra en el lado
