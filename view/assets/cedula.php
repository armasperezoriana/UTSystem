...
use content\controllers\usuariosController as usuariosController;
...
$jsonData = array();
//$selectQuery   = "SELECT * FROM usuarios WHERE status = 1 and cedula = '{$this->cedula}'";
$query =("SELECT * FROM usuarios WHERE status = 1 and cedula = '{$this->cedula}'");
				$respuestaArreglo = '';
				$query->execute();
