...
<ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                  ...
                  if (in_array('vehiculos', $_SESSION['ut_permisos']))
            {
                 ?>
             <li class="nav-item">
                <a class="nav-link collapsed" data-toggle="modal" data-target="#modalSeguridadVehiculos">
...
<!-- MODAL IMAGEN DE SEGURIDAD VEHICULOS -->
<div class="modal fade" id="modalSeguridadVehiculos" role="dialog" data-controls-modal="your_div_id"
    data-backdrop="static" data-keyboard="false">>
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Body -->
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form id="modalSeguridadVehiculos">
                    <input type="hidden" id="id_usuario" name="id_usuario">
                    <div class="form-group">
                        <div class="modal-header bg-primary" style="color:#FFF">
                            <center>
                    ...
                    <div class="container">
                        <div>
                            <div class="" role="document"  id="modalSeguridadVehiculos">
                                <TABLE>
                                    <TR>
                                        <TH>
                                            <center> IMAGEN 1</center>
