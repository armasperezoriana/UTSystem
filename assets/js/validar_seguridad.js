...
$(document).ready(function() {
    $(".ConsultarSeguridad").click(function() { 
      ...
      if (validarS== true) {
         // var id_usuario = $("#modalSeguridadVehiculos").find("#id_usuario").val();
            var preguntauno = $("#modalSeguridadVehiculos").find("#preguntauno").val();       
            var respuestauno = $("#modalSeguridadVehiculos").find("#respuestauno").val(); 
        ...
        function validarSeguridad(modificar = false){
            var form = "#modalSeguridadVehiculos";
